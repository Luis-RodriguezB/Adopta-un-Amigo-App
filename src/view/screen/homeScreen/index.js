  ...
  return (
    <View style={style.container}>
      <View style={{ flex: 3, margin: 0 }}>
        ...
        >
          Somos una organización sin fines de lucro que buscar rescatar y darles
          un hogar a los perros de la calle en la zona de Liberia.
        </Text>
      </View>
...
const style = StyleSheet.create({
  container: { flex: 1, paddingTop: 40, margin: 0 },
  image: {
    flex: 1,
    resizeMode: "stretch",
    alignItems: "center",
